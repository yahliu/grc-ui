...
var _ref2 = React.createElement(
  ...
  React.createElement(
    ...
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.2', stopOpacity: '0' }),
    React.createElement('stop', {
      stopColor: 'currentColor',
      offset: '0.28658',
      stopOpacity: '0.02999'
    }),
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.50065', stopOpacity: '0.2' }),
    React.createElement('stop', {
      stopColor: 'currentColor',
      offset: '0.79313',
      stopOpacity: '0.74185'
    }),
    React.createElement('stop', { stopColor: 'currentColor', offset: '1' })
  ),
  React.createElement(
    'linearGradient',
    {
      ...
      gradientUnits: 'userSpaceOnUse' },
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.08' }),
    React.createElement('stop', {
      stopColor: 'currentColor',
      offset: '0.75275',
      stopOpacity: '0.07'
    }),
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.8746', stopOpacity: '0' })
  ),
  React.createElement(
    'linearGradient',
    {
      ...
      gradientTransform: 'matrix(1, 0, 0, -1, -5.791, 224.13485)',
      gradientUnits: 'userSpaceOnUse' },
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.1381', stopOpacity: '0' }),
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.3197', stopOpacity: '0.07' }),
    React.createElement('stop', {
      stopColor: 'currentColor',
      offset: '0.84728',
      stopOpacity: '0.76377'
    }),
    React.createElement('stop', { stopColor: 'currentColor', offset: '0.94689' })
  )
);
...
var Loading = function Loading(_ref) {
  ...
  var LoadingClasses = classNames(_defineProperty({

...
function (_Component) {
  ...
  _createClass(DatePickerInput, [{
    ...
    value: function render() {
      ...
      }, componentsX ? React.createElement(React.Fragment, null, label, React.createElement("div", {
        className: "".concat(prefix, "--date-picker-input__wrapper")
      }, input, datePickerIcon)) : React.createElement(React.Fragment, null, datePickerIcon, label, input), error);
    }
  }]);

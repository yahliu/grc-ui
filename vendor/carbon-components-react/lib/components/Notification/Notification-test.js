...
describe('NotificationButton', function () {
  describe('Renders as expected', function () {
    ...
    it('renders only one Icon', function () {
      var icon = wrapper.find(!_FeatureFlags.componentsX ? 'Icon' : _.default);
    ...
    it('supports custom icon', function () {
      ...
      var originalIcon = (0, _enzyme.mount)(_react.default.createElement(_.default, null)).find('svg');
  ...
  describe('Renders as expected', function () {
    ...
    it('renders success notification with matching kind and <icon name=""> values', function () {
      ...
      if (!_FeatureFlags.componentsX) {
        ...
        expect(inline.find(_3.default).length).toBe(1);
      }
    });
    it('renders error notification with matching kind and <icon name=""> values', function () {
      ...
      if (!_FeatureFlags.componentsX) {
        ...
        expect(inline.find(_2.default).length).toBe(1);
      }
    });
    ...
    it('interpolates matching className based on kind prop', function () {
      ...
      kinds.forEach(function (kind) {
        ...
        expect(inline.find(".bx--inline-notification--".concat(kind)).exists()).toEqual(true);
      });
    });
    it('has [role="alert"] on wrapping <div>', function () {
...
describeBreakingChangesXFeatures('[Deprecated]: Notification', function () {
  describe('Renders as expected', function () {

  ...
  _createClass(DatePickerInput, [{
    ...
    value: function render() {
      ...
      var datePickerIcon = function () {
        if (!_FeatureFlags.componentsX && datePickerType !== 'single') {
          return;
        }

        if (_FeatureFlags.componentsX && datePickerType === 'simple') {
          return;
        }
      ...
      }, _FeatureFlags.componentsX ? _react.default.createElement(_react.default.Fragment, null, label, _react.default.createElement("div", {
        className: "".concat(prefix, "--date-picker-input__wrapper")
      }, input, datePickerIcon)) : _react.default.createElement(_react.default.Fragment, null, datePickerIcon, label, input), error);
    }
  }]);

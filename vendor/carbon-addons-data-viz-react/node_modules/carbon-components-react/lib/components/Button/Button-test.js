...
describe('Button', function () {
  describe('Renders common props as expected', function () {
    ...
    _react2.default.createElement(
      _Button2.default,
      { tabIndex: 2, className: 'extra-class' },
      _react2.default.createElement(
        'div',
        { className: 'child' },
        'child'
    ...
    _react2.default.createElement(
      _Button2.default,
      { tabIndex: 2, className: 'extra-class', href: '/home' },
      _react2.default.createElement(
        'div',
        { className: 'child' },
        'child'
  ...
  describe('Renders icon buttons', function () {
    var iconButton = (0, _enzyme.mount)(_react2.default.createElement(
      _Button2.default,
      { icon: 'search', iconDescription: 'Search' },
      'Search'
    ));
    ...
    it('should return error if icon given without description', function () {
      ...
      expect(_Button2.default.propTypes.iconDescription(props)).toEqual(error);
    });
  });
});
...
describe('Primary Button', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Button2.default, { className: 'extra-class' }));
...
describe('Secondary Button', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Button2.default, { kind: 'secondary', className: 'extra-class' }));
...
describe('Ghost Button', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Button2.default, { kind: 'ghost', className: 'extra-class' }));
...
describe('Small Button', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Button2.default, { small: true, className: 'extra-class' }));
...
describe('DangerButton', function () {
  describe('Renders as exptected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Button2.default, { kind: 'danger', className: 'extra-class' }));

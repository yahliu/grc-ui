...
describe('Modal', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Modal2.default, { className: 'extra-class' }));
    var mounted = (0, _enzyme.mount)(_react2.default.createElement(_Modal2.default, { className: 'extra-class' }));
    ...
    it('should set id if one is passed via props', function () {
      var modal = (0, _enzyme.shallow)(_react2.default.createElement(_Modal2.default, { id: 'modal-1' }));
  ...
  describe('Adds props as expected to the right children', function () {
    it('should set label if one is passed via props', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Modal2.default, { modalLabel: 'modal-1' }));
    ...
    it('should set modal heading if one is passed via props', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Modal2.default, { modalHeading: 'modal-1' }));
    ...
    it('should set button text if one is passed via props', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Modal2.default, { primaryButtonText: 'Submit', secondaryButtonText: 'Cancel' }));
  ...
  describe('events', function () {
    it('should set expected class when state is open', function () {
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_ModalWrapper2.default, null));
      var modal = wrapper.find(_Modal2.default);
    ...
    it('should handle keyDown events', function () {
      ...
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_Modal2.default, { onRequestClose: onRequestClose }));
    ...
    it('should close by default on secondary button click', function () {
      var onRequestClose = jest.fn();
      var modal = (0, _enzyme.mount)(_react2.default.createElement(_Modal2.default, { onRequestClose: onRequestClose }));
    ...
    it('should handle custom secondary button events', function () {
      ...
      var modal = (0, _enzyme.mount)(_react2.default.createElement(_Modal2.default, { onSecondarySubmit: onSecondarySubmit }));
      var secondaryBtn = modal.find('.bx--btn--secondary');
      secondaryBtn.simulate('click');

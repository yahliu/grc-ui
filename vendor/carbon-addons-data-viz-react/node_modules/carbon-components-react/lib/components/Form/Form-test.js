...
describe('Form', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Form2.default, { className: 'extra-class' }));
    ...
    it('should render wrapper as expected', function () {
      var form = (0, _enzyme.shallow)(_react2.default.createElement(
        _Form2.default,
        null,
    ...
    it('should render children as expected', function () {
      var form1 = (0, _enzyme.shallow)(_react2.default.createElement(
        _Form2.default,
        null,
    ...
    it('should handle submit events', function () {
      ...
      var form1 = (0, _enzyme.mount)(_react2.default.createElement(
        _Form2.default,
        null,
        _react2.default.createElement(
          'button',
          { className: 'button', type: 'submit', onSubmit: onSubmit },
          'Submit'
        )
      ));

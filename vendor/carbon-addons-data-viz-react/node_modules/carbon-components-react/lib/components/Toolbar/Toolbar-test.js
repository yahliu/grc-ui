...
var _ToolbarSearch = require('../ToolbarSearch');
...
describe('Toolbar', function () {
  describe('renders as expected', function () {
    var toolbar = (0, _enzyme.mount)(_react2.default.createElement(_Toolbar2.default, { className: 'extra-class' }));
  ...
  describe('Toolbar Search Item', function () {
    var toolbar = (0, _enzyme.mount)(_react2.default.createElement(
      _Toolbar2.default,
      { className: 'extra-class' },
      _react2.default.createElement(_Toolbar.ToolbarItem, { type: 'search' })
    ));

    var toolbarSearch = (0, _enzyme.mount)(_react2.default.createElement(_ToolbarSearch2.default, { placeHolderText: 'Test placeholder' }));
    ...
    it('should minimize the search when clicking outside of the search item', function () {
      var rootWrapper = (0, _enzyme.shallow)(_react2.default.createElement(_ToolbarSearch2.default, null));
  ...
  describe('ToolbarItem with an overflow menu', function () {
    var toolbarItem = (0, _enzyme.mount)(_react2.default.createElement(
      _Toolbar.ToolbarItem,
      null,
      _react2.default.createElement(_OverflowMenu2.default, null)
    ));

    it('should render an overflow menu inside a toolbar item', function () {
      expect(toolbarItem.find(_OverflowMenu2.default).length).toEqual(1);
    });

    describe('with ToolbarTitle ', function () {
      var withToolbarTitle = (0, _enzyme.mount)(_react2.default.createElement(
        _Toolbar.ToolbarItem,
        null,
        _react2.default.createElement(
          _OverflowMenu2.default,
          { open: true },
          _react2.default.createElement(_Toolbar.ToolbarTitle, { title: 'Test title' })
        )
      ));
    ...
    describe('with ToolbarOption ', function () {
      var withToolbarOption = (0, _enzyme.mount)(_react2.default.createElement(
        _Toolbar.ToolbarItem,
        null,
        _react2.default.createElement(
          _OverflowMenu2.default,
    ...
    describe('with ToolbarDivider ', function () {
      var withToolbarDivider = (0, _enzyme.mount)(_react2.default.createElement(
        _Toolbar.ToolbarItem,
        null,
        _react2.default.createElement(
          _OverflowMenu2.default,
          { open: true },
          _react2.default.createElement(_Toolbar.ToolbarDivider, null)
        )
      ));

...
resources(() => {
  require('../../../scss/module-integration-policies.scss')
})

export default class IntegrationPoliciesModule extends React.Component {
...
IntegrationPoliciesModule.propTypes = {
}

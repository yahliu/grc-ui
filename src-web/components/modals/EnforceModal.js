...
export class EnforceModal extends React.Component {
  constructor(props) {
    super(props)
  ...
  handleSubmitClick() {
    ...
    handleSubmit(resourceType, data.namespace, data.name, 'enforce', data.metadata.selfLink, '/spec/remediationAction')
  }
    ...
    return (
      <div>
        ...
        <Modal
          ...
          <p>{msgs.get('modal.enforce.description', locale)}</p>
        </Modal>
      </div>
    )
  }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(EnforceModal))

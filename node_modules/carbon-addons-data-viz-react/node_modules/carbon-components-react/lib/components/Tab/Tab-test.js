...
describe('Tab', function () {
  describe('renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Tab2.default, { label: 'firstTab' }));
  ...
  describe('events', function () {
    describe('click', function () {
      ...
      it('invokes handleTabClick from onClick prop', function () {
        wrapper.setProps({ handleTabClick: handleTabClick });
    ...
    describe('keydown', function () {
      ...
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Tab2.default, { label: 'firstTab' }));
      wrapper.setProps({ onKeyDown: onKeyDown, handleTabAnchorFocus: handleTabAnchorFocus, handleTabKeyDown: handleTabKeyDown });

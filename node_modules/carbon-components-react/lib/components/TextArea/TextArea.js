...
var TextArea = function TextArea(_ref) {
  ...
  var input = _react.default.createElement("textarea", _extends({}, other, textareaProps, {
    ...
    "data-invalid": invalid && !_FeatureFlags.componentsX || null,
    disabled: other.disabled
  }));

  return _react.default.createElement("div", {
    className: "".concat(prefix, "--form-item")
  }, label, _FeatureFlags.componentsX && helper, _FeatureFlags.componentsX ? _react.default.createElement("div", {
  ...
  }), input) : input, !_FeatureFlags.componentsX && helper, error);
};

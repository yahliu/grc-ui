...
describe('OverflowMenu', function () {
  describe('Renders as expected', function () {
    ...
    var icon = menu.find(!componentsX ? Icon : OverflowMenuVertical16);
    ...
    it('should apply a tabindex to the menu', function () {
      if (!breakingChangesX) {
        ...
        var _defaultMenu = mount(React.createElement(OverflowMenu, null, React.createElement("div", null, "Child"))).childAt(0); // Enzyme doesn't seem to allow props() in a forwardRef-wrapped class component

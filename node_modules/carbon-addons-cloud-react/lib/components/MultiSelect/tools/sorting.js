 ...
 * @returns {number}
 */
var defaultCompareItems = exports.defaultCompareItems = function defaultCompareItems(itemA, itemB, _ref) {
 ...
 */
var defaultSortItems = exports.defaultSortItems = function defaultSortItems(items, _ref2) {
  ...
  return items.sort(function (itemA, itemB) {
    ...
    var hasItemB = selectedItems.includes(itemB);
    ...
    if (parent) {
      var checkedItemA = itemA.checked;
      var checkedItemB = itemB.checked;

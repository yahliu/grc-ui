...
describe('RHACM4K-1723 - GRC UI: [P1][Sev1][policy-grc] SecurityContextConstraints policy governance', () => {
...
describe('GRC UI: [P1][Sev1][policy-grc] SecurityContextConstraints policy governance - clean up', () => {

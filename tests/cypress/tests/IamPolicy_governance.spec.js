...
describeT('@bvt GRC UI: [P1][Sev1][policy-grc] IamPolicy governance - setup', () => {
  test_applyPolicyYAML('IamPolicy_governance/policy-clusterrolebinding-setup_raw.yaml')
})

describeT('@bvt RHACM4K-1719 - GRC UI: [P1][Sev1][policy-grc] IamPolicy governance', () => {
...
describeT('@bvt GRC UI: [P1][Sev1][policy-grc] IamPolicy governance - cleanup', () => {

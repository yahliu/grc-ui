...
describeT('@extended @bvt GRC UI: [P1][Sev1][policy-grc] IamPolicy governance - setup', () => {
  test_applyPolicyYAML('IamPolicy_governance/policy-clusterrolebinding-setup_raw.yaml')
})

describeT('@extended @bvt RHACM4K-1719 - GRC UI: [P1][Sev1][policy-grc] IamPolicy governance', () => {
...
describeT('@extended @bvt GRC UI: [P1][Sev1][policy-grc] IamPolicy governance - cleanup', () => {

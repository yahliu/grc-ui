...
import PolicyStatusHistoryTab from '../../../src-web/containers/PolicyStatusHistoryTab'
...
describe('PolicyStatusHistoryTab container test', () => {
  it('renders as expected', () => {
    ...
    expect(toJson(component.find(PolicyStatusHistoryTab))).toMatchSnapshot()
  })
})
